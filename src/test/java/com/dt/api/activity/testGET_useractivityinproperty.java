...
public class testGET_useractivityinproperty extends Baseclass {
	@SuppressWarnings("rawtypes")
	@Test
	public void testGet001() throws FileNotFoundException, IOException {
	    response = httpRequest.log().all()
				.get(Endpoints.useractivityinproperty ,Config.getpropertyID(),Config.getemailID()).andReturn();
