package com.dt.api.collection.get;
...
public class testGET_getalldevicesandzonesinacollection extends Baseclass {
	...
	public void testGet001() throws FileNotFoundException, IOException {
		Response response = given()
				...
				.get(Endpoints.getalldevicesandzonesinacollection, Config.getemailID()).andReturn();
