package com.dt.api.schedule.get;
...
public class testGET_getlockmonitoringinterval extends Baseclass {
	...
	public void testGet001() throws FileNotFoundException, IOException {
		Response response = given()
				...
				.get(Endpoints.getlockmonitoringinterval, Config.getdeviceID()).andReturn();
