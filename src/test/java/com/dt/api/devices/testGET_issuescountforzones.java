package com.dt.api.devices.get;
...
public class testGET_issuescountforzones extends Baseclass{
	...
	public void testGet001() throws FileNotFoundException, IOException {
		Response response = given()
				...
				.get(Endpoints.issuescountforzones,Config.getpropertyID(), Config.getzoneID()).andReturn();
