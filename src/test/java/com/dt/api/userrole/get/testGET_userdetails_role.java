package com.dt.api.userrole.get;
...
public class testGET_userdetails_role extends Baseclass {
	...
	public void testGet001() throws FileNotFoundException, IOException {
		Response response = given()
				...
				.get(Endpoints.userdetails_role, Config.getpropertyID(),Config.getemailID(),true).andReturn();
