...
public class testPUT_requestgeneratekeyforguestorstaff extends Baseclass {
	...
	public void testPUT001() throws FileNotFoundException, IOException {
		given().headers("accept", "application/json", "Authorization", "bearer " + Config.getToken())
				...
				.body(request.toJSONString()).when().put(Endpoints.requestgeneratekeyforguestorstaff,Config.getkeyID()).then().statusCode(200);
	}
