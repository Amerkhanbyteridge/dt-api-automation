...
public class testPUT_updatekeytimerequestforguestorstaff extends Baseclass {
	...
	public void testPUT001() throws FileNotFoundException, IOException {
		given().headers("accept", "application/json", "Authorization", "bearer " + Config.getToken())
				...
				.body(request.toJSONString()).when().put(Endpoints.updatekeytimerequestforguestorstaff).then().statusCode(200);
	}
