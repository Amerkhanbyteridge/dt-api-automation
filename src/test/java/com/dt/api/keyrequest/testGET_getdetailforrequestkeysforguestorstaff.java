package com.dt.api.keyrequest.get;
...
public class testGET_getdetailforrequestkeysforguestorstaff extends Baseclass {
	...
	public void testGet001() throws FileNotFoundException, IOException {
		Response response = given()
				...
				.get(Endpoints.getdetailforrequestkeysforguestorstaff, Config.getpropertyID(),Config.gettype()).andReturn();
