...
public class testGET_rooms extends Baseclass{


	@SuppressWarnings("rawtypes")
	@Test
	public void testGetrooms() throws FileNotFoundException, IOException {
		Response response = given()
				.headers("Authorization", "bearer " + Config.getToken(), "accept", "application/json").log().all()
				.get(Endpoints.rooms ,Config.getpropertyID()).andReturn();
